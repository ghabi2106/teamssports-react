...
import { emailValidation } from '../../../models/Formatter';
              ...
              <div className="row  ">
                <div className="col-md-6">
                  ...
                  <h1 className="Welcome-back d-flex justify-content-center ">
                    Confirmer votre email to Login
                    </h1>
                  ...
                  <form onSubmit={this.handleSubmit}>
                    <div className="form-group " style={{ marginBottom: '0%' }}>
                      ...
                      <ValidationMessage submitted={submitted} type="email" value={email} message="Email is required" />
                    </div>
                    <div className="d-flex justify-content-center">
